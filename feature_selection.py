...
def select_features(X, y, n_features, folder):
    file_features = f"{folder}/features/selected_features_" + str(n_features) + ".pkl"
    if os.path.exists(file_features):
        ...
        with open(f"{folder}/features/selected_features_" + str(n_features) + ".pkl", "wb") as f:
